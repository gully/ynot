...
The documentation uses Mathjax for displaying math.  This may not render on certain browsers, or if Javascript is disabled.  Here is an inline demo: :math:`a \cdot x^2+b \lambda` that should appear as beautifully rendered web-based math.  If not, let us know in the project's GitHub Issues.
