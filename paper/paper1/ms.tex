...
\textbf{The remarkable promise and pervasiveness of astronomical spectroscopy.}
Virtually all modern insights derived from observational optical spectroscopy first arrive through the lossy, imperfect, and unavoidable process of digitization onto a 2-dimensional focal plane array detector.  Moore's law has propelled the amount of spectrosopic information we can cram onto these detectors, with the number of pixels increasing up to a billion-fold in 50 years.  Innovative optical designs have made evermore effective use of the growth in detector area with information-rich multi-object spectrograph and \`echellogram layouts.  The computerized distillation of these signals is generally turnkey.  Facility reduction pipelines provide the humdrum translation of raw 2D pixels to familiar 1D extract spectra, ideally an afterhought in a practioner's journey from observation to scientific results.  But increasing our greatest scientific ambitions are pushing against the limits of how much information we can squeeze out of a given spectrographic observation.  The discovery of other Earths, the redshift of reionization, and some of the most important unrealized astronomical discoveries will occur in the margins of what our most powerful spectrographs can deliver.

The measurement of Extreme Precision Radial Velocity (EPRV) stands out as particularly susceptible to the vagueries of the data collection process...

The pixelization process demarcates the monotonically increasing wavelengths like minor ticks on a ruler.  The brightness of the pixels
